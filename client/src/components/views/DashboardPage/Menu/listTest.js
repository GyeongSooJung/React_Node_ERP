...
function createData(CNU, CNA, CEON, CAD, CTEL, BRI) {
  return { CNU, CNA, CEON, CAD, CTEL, BRI };
}
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState('CNA');
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="center">{row.CNA}</TableCell>
                          <TableCell align="center">{row.CEON}</TableCell>
                          <TableCell align="center">{row.CAD}</TableCell>
                          <TableCell align="center">{row.CTEL}</TableCell>
                          <TableCell align="center">{row.BRI}</TableCell>
                        </TableRow>
                      );
                    })}
                  {emptyRows > 0 && (
